...
const TEAM: Teammate[] = [
  {
    ...
    image: "https://i.pravatar.cc/480?img=60",
    initials: "AM",
  ...
  },
  {
    ...
    initials: "PS",
    gradient: "from-[#B600A8] to-[#7621B0]",
    dir: 1, spread: 0.64, rotate: 8,
  },
  {
    name: "Rohan Verma",
    ...
    image: "https://i.pravatar.cc/480?img=51",
    initials: "RV",
  ...
  },
  {
    name: "Neha Gupta",
    role: "QA & Performance",
    detail: "Core Web Vitals • Audits",
    image: "https://i.pravatar.cc/480?img=16",
    initials: "NG",
    gradient: "from-[#00f2fe] to-[#00c853]",
    dir: 1, spread: 1.02, rotate: 15,
  },
];
